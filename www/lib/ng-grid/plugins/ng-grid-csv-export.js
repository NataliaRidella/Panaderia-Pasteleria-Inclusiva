...
function ngGridCsvExportPlugin (opts) {
    ...
    self.init = function(scope, grid, services) {
        ...
        function showDs() {
            ...
            csvDataLinkHtml += '<br><a class="button button-light button-small ion-android-download" href="data:text/csv;charset=UTF-8,';
            csvDataLinkHtml += encodeURIComponent(csvData);
            csvDataLinkHtml += '" target="_blank" download="' + opts.fileName + '">' + opts.linkLabel + '</a></br></span>' ;
